  ...
  return (
    <>
        <section className="text-gray-600 body-font overflow-hidden">
                <div className="w-[90%] sm:w-[80%] lg:py-32 py-6 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        <img
                            alt="ecommerce"
                            className="lg:w-1/2 w-full lg:h-auto h-64 sm:h-80  object-cover object-center rounded"
                            src="https://dummyimage.com/400x400"
                        />
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 flex flex-wrap flex-col">
                            ...
                            <div className="flex mb-4">
                                <span className="flex items-center">
                                    ...
                                    <span className="text-gray-600 ml-3" style={{color :mode==="dark"? "white":""}}>4 Reviews</span>
                                </span>
